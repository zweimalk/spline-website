    ...
    <div className='container mx-auto px-4 md:mt-60 '>
      ...
      <div className='flex flex-col gap-y-6 pt-10 md:grid md:grid-cols-3 md:gap-x-10'>
        ...
        <p className='md:text-justify'>
          ...
          contributions to every project. Beyond technology, we create a workplace where people
        </p>
        <p className='md:text-justify'>
          feel inspired and supported. Our focus extends beyond delivering solutions—we build lasting relationships,
          nurture talent, and cultivate a company culture where passion and expertise drive success.
        </p>
      </div>
    </div>
  );
