...
export const AboutUsSection = () => {
  return (
    <div className='container mx-auto px-4 md:mt-20 lg:mt-40'>
      ...
      />
      <div className='flex flex-col gap-y-6 pt-10 md:grid md:grid-cols-2 md:gap-x-10 lg:hidden'>
      ...
      <div className='hidden lg:block pt-10'>
        <Body1 className='columns-3 gap-x-10 h-[400px] text-justify'>
          {' '}
          {/* Adjust height as needed */}
          At Spline, we believe that great technology starts with great people. Our culture is built on collaboration,
          curiosity, and continuous learning. We foster an environment where engineers, designers, and developers can
          grow and solve complex challenges with creativity and precision. Every idea matters, and innovation thrives
          when people are encouraged to experiment and push boundaries. We embrace teamwork and trust, ensuring that
          every project benefits from diverse expertise and fresh perspectives. Flexibility and open communication are
          at the core of our approach, allowing us to adapt to challenges and deliver high-quality solutions. We value
          ownership, giving our team the freedom to take initiative and make meaningful contributions to every project.
          Beyond technology, we create a workplace where people feel inspired and supported. Our focus extends beyond
          delivering solutions—we build lasting relationships, nurture talent, and cultivate a company culture where
          passion and expertise drive success.
        </Body1>
