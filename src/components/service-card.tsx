...
export const ServiceCard = ({ title, description, image, tags }: ServiceCardProps) => {
  return (
    <div className='group transition-colors duration-300 lg:hover:bg-foreground md:p-4 rounded-lg cursor-pointer max-w-[532px] shadow-[0_8px_30px_rgba(0,0,0,0.12)] lg:p-5 xl:shadow-none'>
