...
export const HighlightCard = ({ highlight }: HighlightCardProps) => {
  ...
  return (
    <div className='group relative overflow-hidden rounded-2xl shadow-md transition-all dark:bg-light-black cursor-pointer w-full hover:bg-white dark:hover:bg-[#272727] clip-diagonal-top-left clip-diagonal-top-left-sm'>
      {/* Image Container */}
      ...
      <div className='p-6 grid grid-rows-[auto_auto_1fr_auto] h-[288px]'>
        ...
        {/* Description */}
        <div>
          <Body1 className='text-gray-5 dark:text-dark-text mt-5 line-clamp-3'>{description}</Body1>
        </div>
